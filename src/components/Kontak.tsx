      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="section-subtitle">
            Kami siap melayani pertanyaan dan kebutuhan informasi Anda. 
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl border border-neutral-100 p-6 space-y-5">
              ...
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-primary-100 flex items-center justify-center text-primary-700 flex-shrink-0">
                ...
                <div>
                  <p className="text-xs text-neutral-400 font-medium mb-0.5">Alamat</p>
                  <p className="text-neutral-700 text-sm leading-relaxed">
                    Desa Soga, Kec. Marioriwawo,<br />Kab. Soppeng
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-neutral-400 font-medium mb-0.5">Telepon</p>
                  <p className="text-neutral-700 text-sm">0XXX-XXXX-XXXX (Placeholder)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-700 text-sm">middicoppeng@gmail.com</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl overflow-hidden border border-neutral-200 shadow-sm h-full min-h-[400px]">
              <iframe
                src={MAPS_EMBED}
                width="100%"
                height="100%"
