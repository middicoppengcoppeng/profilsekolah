      ...
      <div className="container-custom py-12 lg:py-16">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="text-neutral-400 text-sm leading-relaxed">
              Madrasah Ibtidaiyah yang berkomitmen membentuk generasi muslim yang
          ...
          {/* Navigasi */}
          <div>
            <h3 className="font-bold text-white mb-5">Navigasi</h3>
              ...
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="text-neutral-400 hover:text-white text-sm transition-colors focus:outline-none focus:text-white"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          {/* Kontak */}
          <div>
            <h3 className="font-bold text-white mb-5">Kontak</h3>
            <div className="space-y-3 text-sm text-neutral-400">
              <p className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-primary-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                Desa Soga, Kec. Marioriwawo, Kab. Soppeng
              </p>
              <p className="flex items-center gap-2">
                ...
                0812-XXXX-XXXX (Placeholder)
              </p>
              <p className="flex items-center gap-2">
                <svg className="w-4 h-4 text-primary-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                middicoppeng@gmail.com
              </p>
              <p className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 text-primary-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-center sm:text-left">
            ...
            <p className="text-neutral-600 text-xs mt-1 font-bold bg-primary">
              Dibuat oleh HIMATIKOM UNIPOL
            </p>
          </div>
